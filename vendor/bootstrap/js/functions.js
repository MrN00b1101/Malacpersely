   ...
   var inOutSum = 0;
    for(i=0; i< obj.length;i++){
        if(obj[i].Value > 0)
        {
           ...
           document.getElementById("updateTrans").innerHTML += '<option id="' + i + '" type="button" class="btn btn-secondary btn-sm"> Módosítás </option>'+"<br>";
            document.getElementById("deleteTrans").innerHTML += '<option id="' + i + '" type="button" class="btn btn-secondary btn-sm"> Törlés </option>'+"<br>";
        ...
        document.getElementById("updateTrans2").innerHTML += '<option id="' + i + '" type="button" class="btn btn-secondary btn-sm"> Módosítás </option>'+"<br>";
        document.getElementById("deleteTrans2").innerHTML += '<option id="' + i + '" type="button" class="btn btn-secondary btn-sm"> Törlés </option>'+"<br>";
        inOutSum+=parseInt(obj[i].Value);
        }
}
